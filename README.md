...
|---|---|---|---|
| 👩🏻‍💻 [LinkedIn WebScrapper](https://github.com/zefrios/Python/blob/main/LinkedIn%20Webscrapper/README.md) | Data Mining | This is a Google Chrome webscrapper that works with the unsigned LinkedIn job search site for Marketing Automation jobs in Paris, France. | Selenium, pandas | 
